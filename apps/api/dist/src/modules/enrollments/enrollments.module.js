...
const enrollment_guard_1 = require("./enrollment.guard");
...
exports.EnrollmentsModule = EnrollmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [enrollments_service_1.EnrollmentsService, enrollment_guard_1.EnrollmentGuard],
        exports: [enrollments_service_1.EnrollmentsService, enrollment_guard_1.EnrollmentGuard],
    })
], EnrollmentsModule);
