...
let VectorRepository = class VectorRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async searchLessonChunk(lessonId) {
    ...
    async saveEmbedding(lessonId, embedding, meta) {
        return { lessonId, embedding, meta };
    }
};
exports.VectorRepository = VectorRepository;
exports.VectorRepository = VectorRepository = __decorate([
