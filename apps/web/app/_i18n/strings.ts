...
const kk: I18nStrings = {
  common: {
    ...
    search: "Іздеу", filter: "Сүзу", loading: "Жүктелуде...", error: "Қате",
    success: "Сәтті орындалды", confirm: "Растау", close: "Жабу", back: "Артқа",
    next: "Келесі", previous: "Алдыңғы", refresh: "Жаңарту", submit: "Жіберу",
    reset: "Қалпына келтіру", download: "Жүктеп алу", upload: "Жүктеу", copy: "Көшіру",
    copied: "Көшірілді", send: "Жіберу", view: "Қарау", create: "Жасау",
    update: "Жаңарту", remove: "Жою", enable: "Қосу", disable: "Өшіру",
    all: "Барлығы", none: "Жоқ", yes: "Иә", no: "Жоқ", ok: "Жарайды",
    retry: "Қайта байқау", noData: "Дерек табылмады", noResults: "Нәтиже жоқ",
    demoMode: "Демо режим", loginRequired: "Кіру қажет",
  },
  roles: {
    admin: "Әкімші", headInstructor: "Бас оқытушы",
    instructor: "Оқытушы", student: "Студент", guardian: "Ата-ана",
  },
  nav: {
    brandSub: "Жаһандық оқу торы", login: "Кіру", logout: "Шығу",
    roleLabel: "Рөл", langLabel: "Тіл",
    search: "Іздеу (⌘K / Ctrl+K)", darkMode: "Қараңғы режим", lightMode: "Жарық режим",
    aiMentor: "Ghost-Mentor AI", notifications: "Хабарландырулар",
    security: "Қауіпсіздік дабылдары", myCourses: "Менің курстарым",
    profile: "Профиль", back: "Артқа", forward: "Алға", home: "Басты бет",
    dashboard: "Әкімші тақтасы", alarmsTip: "Қауіпсіздік дабылы",
  },
  login: {
    heroPill: "Көп рөлді қатынау · SSO дайын",
    heroTitle1: "Бір экраннан", heroTitle2: "барлық Atlasio рөлдеріне кіру",
    heroDesc: "Әкімші, оқытушы, студент және ата-ана үшін бірыңғай кіру. MFA-ға дайын, zero-trust қағидасында жасалған.",
    formTitle: "Кіру", formSub: "Atlasio сәйкестендіру орталығы",
    email: "Электронды пошта", emailPh: "epost@domain.com",
    password: "Құпиясөз", passwordPh: "Кемінде 8 таңба",
    loading: "Кіру орындалуда...", submit: "Кіру",
    noAccount: "Тіркелгіңіз жоқ па?", register: "Тіркелу", forgotPassword: "Құпиясөзді ұмыттым",
    roleButtons: [
      { key: "admin", label: "Әкімші" }, { key: "instructor", label: "Оқытушы" },
      { key: "student", label: "Студент" }, { key: "guardian", label: "Ата-ана" },
    ],
  },
  register: {
    heroPill: "Тегін бастаңыз", heroTitle: "Atlasio-ға қош келдіңіз.",
    heroDesc: "Мыңдаған курс, тікелей сабақтар және жекелендірілген оқу жолы сізді күтеді.",
    stat1Label: "Белсенді студент", stat1Value: "12K+",
    stat2Label: "Курс саны", stat2Value: "380+",
    stat3Label: "Орташа баға", stat3Value: "4.8★",
    formTitle: "Тіркелгі құру", formSub: "Тегін, бірнеше минутта дайын.",
    name: "Аты-жөні", namePh: "Атыңыз (қалауыңыз бойынша)",
    email: "Электронды пошта", emailPh: "epost@domain.com",
    password: "Құпиясөз", passwordPh: "Кемінде 8 таңба",
    passwordHint: "Кемінде 8 таңба",
    confirmPassword: "Құпиясөзді растаңыз", confirmPh: "Құпиясөзді қайта енгізіңіз",
    submit: "Тіркелу", loading: "Тіркелгі құрылуда...",
    haveAccount: "Тіркелгіңіз бар ма?", loginLink: "Кіру",
    errorMismatch: "Құпиясөздер сәйкес келмейді", errorWeak: "Құпиясөз тым әлсіз",
  },
  auth: {
    forgotTitle: "Құпиясөзді ұмыттыңыз ба?", forgotSub: "Құпиясөзді қалпына келтіру",
    forgotDesc: "Электронды пошта мекенжайыңызды енгізіңіз, біз сізге қалпына келтіру сілтемесін жібереміз.",
    forgotSubmit: "Қалпына келтіру сілтемесін жіберу", forgotLoading: "Жіберілуде...",
    forgotSuccess: "Сілтеме электронды пошта мекенжайыңызға жіберілді.", forgotPill: "Құпиясөзіңізді қалпына келтіріңіз",
    resetTitle: "Жаңа құпиясөз орнату", resetSub: "Құпиясөзді қалпына келтіру",
    newPassword: "Жаңа құпиясөз", newPasswordPh: "Кемінде 8 таңба",
    resetSubmit: "Құпиясөзді жаңарту", resetLoading: "Жаңартылуда...", resetSuccess: "Құпиясөз сәтті жаңартылды.",
    verifyTitle: "Электронды поштаңызды растаңыз", verifySub: "Аз қалды!",
    verifyDesc: "Тіркелгіңізді растау үшін электронды пошта мекенжайыңызға жіберілген сілтемеге басыңыз.",
    verifySuccess: "Электронды пошта мекенжайы сәтті расталды.", verifyLoading: "Расталуда...",
    backToLogin: "Кіру бетіне оралу", rememberPassword: "Құпиясөзімді есіме түсірдім",
  },
  home: {
    pill: "Atlasio 2026 • Жаһандық оқу торы", activePill: "Дәл қазір", activeCount: "студент белсенді",
    title1: "Әлемдік деңгейдегі", title2: "Қашықтан оқыту платформасы",
    slogan: "Білімді құндылыққа айналдыратын цифрлық білім беру платформасы",
    desc: "Тікелей сабақтар, ақылды тақта, AI ментор және сертификаттар — оқытушылар, студенттер мен мекемелер үшін бір экранда.",
    ctaStart: "Тегін бастау", ctaDemo: "▶ Тікелей демо көру", ctaCatalog: "Курстар каталогы",
    trustedBy: "Бізге сенетіндер:", universities: "42 университет",
    companies: "180 компания", countries: "64 ел",
    statsTitle: "Платформа статистикасы", statsHeading: "Цифрлармен Atlasio",
    featuresTitle: "Мүмкіндіктер", featuresHeading: "Барлығы бір платформада",
    featuresDesc: "Жеке тұлғадан кәсіпорынға дейін — бір шатыр астында қажет әр құрал.",
    pricingTitle: "Бағалар", pricingHeading: "Әр қажеттілікке арналған жоспар",
    pricingDesc: "Талаптарыңызбен бірге өсетін икемді жоспарлар.",
    ctaHeading: "Бүгін оқуды бастаңыз", ctaDesc: "14 күндік тегін сынақ. Несие картасы қажет емес.",
    ctaRegister: "Тіркелгі құру", ctaBrowse: "Курстарды шолу",
    testimonialTitle: "Пайдаланушы пікірлері", testimonialHeading: "Мыңдаған риза пайдаланушылар",
    freePlan: "Тегін", proPlan: "Pro", enterprisePlan: "Кәсіпорын",
    monthSuffix: "/ай", customPrice: "Жеке баға",
    planCtaFree: "Бастау", planCtaPro: "Pro-ға өту", planCtaEnterprise: "Бізбен байланысу",
    planDescFree: "Бастау үшін өте қолайлы", planDescPro: "Жеке студенттер мен оқытушыларға",
    planDescEnterprise: "Компаниялар мен университеттерге", highlighted: "Ең танымал",
  },
  dashboard: {
    deniedTitle: "Бұл тақта тек әкімшілер мен бас оқытушыларға арналған.",
    deniedDesc: (role) => `Таңдалған рөл: ${role}. Кіру үшін жоғарғы жолақтан рөлді ауыстырыңыз.`,
    welcomeBack: "Қайтып оралғаныңызға қош келдіңіз",
    quickActions: "Жылдам әрекеттер", recentActivity: "Соңғы әрекет",
    upcomingLive: "Жақын тікелей сабақтар", myMaterials: "Менің материалдарым",
    uploadAssignment: "Тапсырма жүктеу", pendingApprovals: "Күтудегі мақұлдаулар",
  },
  courses: {
    catalogTitle: "Курстар каталогы", catalogDesc: "Кәсіби курстар және сертификат бағдарламалары",
    searchPh: "Курстарды немесе оқытушыларды іздеу...", filterAll: "Барлығы", filterFree: "Тегін", filterPremium: "Премиум",
    sortNewest: "Ең жаңа", sortOldest: "Ең ескі", sortPopular: "Ең танымал", sortRating: "Жоғары бағаланған",
    enrolled: "Тіркелдіңіз", enroll: "Тіркелу", continue: "Жалғастыру", preview: "Алдын ала қарау",
    free: "Тегін", duration: "Ұзақтығы", lessons: "Сабақтар", students: "Студенттер",
    rating: "Баға", instructor: "Оқытушы", level: "Деңгей", certificate: "Сертификат",
    noCoursesFound: "Курс табылмады", loadMore: "Көбірек жүктеу",
    detailOverview: "Шолу", detailCurriculum: "Оқу бағдарламасы",
    detailInstructor: "Оқытушы", detailReviews: "Пікірлер", detailEnroll: "Курсқа тіркелу",
    myCoursesContinue: "Орындалуда", myCoursesCompleted: "Аяқталды", myCoursesAll: "Барлығы",
    skillProfile: "Менің дағды профилім",
  },
  live: {
    title: "Тікелей сабақтар", subtitle: "Нақты уақытта және жоспарланған тікелей сессиялар",
    statusRunning: "ТІКЕЛЕЙ", statusScheduled: "Жоспарланған", statusEnded: "Аяқталды",
    joinBtn: "Сабаққа қосылу", scheduleBtn: "Жоспарлау", endedLabel: "Аяқталды",
    noSessions: "Белсенді сессия табылмады", demoNote: "Демо дерек көрсетіліп тұр",
    participantsLabel: "Қатысушылар", durationLabel: "Ұзақтығы",
  },
  whiteboard: {
    labels: {
      actionsTitle: "Жылдам әрекеттер",
      quickActions: {
        pdf: "PDF жүктеу", presentation: "Слайд қосу", shareScreen: "Экранды бөлісу",
        cameraOn: "Камера", cameraOff: "Камераны тоқтату", quiz: "Тест жариялау", downloadPng: "PNG экспорт",
      },
      viewRole: { instructor: "Оқытушы көрінісі", student: "Студент көрінісі" },
      background: "Фон", thickness: "Қалыңдық", color: "Түс",
      pages: "Бет", newPage: "Жаңа бет", undo: "Қайтару", redo: "Қайталау",
      clear: "Тазарту", close: "Жабу", privateMsg: "Жеке хабар",
      privateTo: "Студент", noMsg: "Хабар жоқ.", send: "Жіберу",
    },
  },
  profile: {
    title: "Менің профилім", subtitle: "Тіркелгі ақпаратын басқарыңыз",
    personalInfo: "Жеке мәлімет", security: "Қауіпсіздік", preferences: "Параметрлер",
    displayName: "Көрсетілетін аты", displayNamePh: "Атыңыз",
    emailLabel: "Электронды пошта", currentPassword: "Ағымдағы құпиясөз", newPassword: "Жаңа құпиясөз",
    changePhoto: "Фотосуретті өзгерту", saveChanges: "Өзгерістерді сақтау",
    saving: "Сақталуда...", successSaved: "Сәтті сақталды", errorSave: "Сақтау сәтсіз аяқталды",
    language: "Тіл", theme: "Тақырып", notifications: "Хабарландырулар",
    darkTheme: "Қараңғы", lightTheme: "Жарық", systemTheme: "Жүйелік",
  },
  notifications: {
    title: "Хабарландырулар", subtitle: "Барлық жүйелік хабарландырулар",
    markAllRead: "Барлығын оқылды деп белгілеу", clearAll: "Барлығын тазарту",
    noNotifications: "Хабарландыру жоқ",
    filterAll: "Барлығы", filterUnread: "Оқылмаған", filterSystem: "Жүйелік",
    typeLesson: "Сабақ", typeCertificate: "Сертификат", typeAlarm: "Дабыл", typeSystem: "Жүйелік",
  },
  leaderboard: {
    title: "Көшбасшылар", subtitle: "Оқу жарысында ең жоғарыға көтерілу",
    rankLabel: "Орын", studentLabel: "Студент", xpLabel: "XP",
    badgesLabel: "Белгілер", streakLabel: "Серия", completedLabel: "Аяқталды",
    filterWeek: "Осы апта", filterMonth: "Осы ай", filterAll: "Барлық уақыт",
    yourRank: "Сіздің орныңыз", topPerformers: "Үздіктер",
  },
  progress: {
    title: "Менің прогресім", subtitle: "Оқу жолыңызды қадағалаңыз",
    overallProgress: "Жалпы прогресс", coursesInProgress: "Орындалуда",
    completedCourses: "Аяқталған курстар", totalXP: "Барлығы XP",
    currentStreak: "Ағымдағы серия", weeklyGoal: "Апталық мақсат",
    achievements: "Жетістіктер", badges: "Белгілер",
    noProgress: "Әлі прогресс жоқ", startLearning: "Оқуды бастау",
  },
  reportCards: {
    title: "Есеп карталары", subtitle: "Кезеңдік академиялық бағалаулар",
    period: "Кезең", overallGrade: "Жалпы баға", attendance: "Қатысым",
    performance: "Үлгерім", comments: "Пікірлер", downloadPDF: "PDF жүктеу",
    noReports: "Есеп табылмады",
  },
  certificates: {
    title: "Менің сертификаттарым", subtitle: "Менің цифрлық куәліктерім",
    issuedOn: "Берілген күні", expiresOn: "Қолданылу мерзімі", verifyBtn: "Тексеру",
    downloadBtn: "Жүктеп алу", shareBtn: "Бөлісу", renewBtn: "Жаңарту",
    noCertificates: "Сертификат табылмады",
    verifyTitle: "Сертификатты тексеру", verifyDesc: "Тексеру үшін сертификат кодын енгізіңіз",
    verifySubmit: "Сертификатты тексеру", verifyPh: "Сертификат коды",
    verifySuccess: "Сертификат жарамды", verifyFail: "Сертификат табылмады немесе жарамсыз",
  },
  exams: {
    title: "Емтихандар", subtitle: "Емтихан және тест тарихыңыз",
    startExam: "Емтиханды бастау", reviewExam: "Қарап шығу", retakeExam: "Қайта тапсыру",
    timeLeft: "Қалған уақыт", questionsCount: "Сұрақтар", passScore: "Өту балы",
    status: { pending: "Күтуде", passed: "Өтті", failed: "Өтпеді", inProgress: "Орындалуда" },
    resultsTitle: "Емтихан нәтижелері", yourScore: "Сіздің балыңыз", correctAnswers: "Дұрыс жауаптар",
    adaptiveTitle: "Бейімделгіш емтихан", adaptiveDesc: "Сұрақтар сіздің деңгейіңізге автоматты түрде бейімделеді",
    difficulty: { easy: "Оңай", medium: "Орташа", hard: "Қиын" },
  },
  ai: {
    title: "AI ментор", subtitle: "Жекелендірілген оқу қолдауы, бірден қол жетімді.",
    online: "Желіде", placeholder: "Сұрақ қойыңыз… (Shift+Enter жаңа жол, Enter жіберу)",
    sendBtn: "Сұрау",
    chips: ["Бұл тақырыпты түсіндір", "Мысал келтір", "Емтихан сұрағын жаз", "Қорытынды", "Не үйрендім?"],
    sources: "Дереккөздер", confidence: "Сенімділік деңгейі", lowConfidence: "Сенімділік төмен — растаңыз",
    disclaimer: "Ghost Mentor AI-ге негізделген — маңызды шешімдер үшін оқытушыңызбен ақылдасыңыз.",
    clearChat: "Чатты тазарту",
    contentTitle: "Контент өңдеуші", contentDesc: "PDF, презентация және құжаттарды талдау",
    tabs: { chat: "Ментор чаты", content: "Контент өңдеуші" },
  },
  booking: {
    title: "Сессияны брондау", subtitle: "Оқытушыңызбен жеке сессияларды жоспарлаңыз",
    selectDate: "Күнді таңдаңыз", selectTime: "Уақытты таңдаңыз", selectInstructor: "Оқытушыны таңдаңыз",
    duration: "Ұзақтығы", notes: "Жазбалар", notesPh: "Сессия жазбаларын енгізіңіз...",
    submit: "Сессияны брондау", submitting: "Брондалуда...",
    success: "Сессия сәтті брондалды",
    cancelBtn: "Болдырмау", rescheduleBtn: "Қайта жоспарлау",
    upcomingSessions: "Алдағы сессиялар", pastSessions: "Өткен сессиялар",
    noSessions: "Сессия табылмады", availableSlots: "Бос орындар",
  },
  payments: {
    title: "Төлемдер", subtitle: "Жазылым және төлем тарихы",
    currentPlan: "Ағымдағы жоспар", upgradePlan: "Жоспарды жаңарту", manageBilling: "Төлемдерді басқару",
    invoices: "Шот-фактуралар", paymentMethod: "Төлем әдісі",
    successTitle: "Төлем сәтті!", successDesc: "Жоспарыңыз белсендірілді.",
    successBtn: "Курстарыма өту",
    cancelTitle: "Төлем бас тартылды", cancelDesc: "Төлем процесі тоқтатылды.",
    cancelBtn: "Қайта байқау",
    amount: "Сома", date: "Күн", status: "Күй", invoice: "Шот-фактура",
  },
  guardian: {
    title: "Ата-ана панелі", subtitle: "Балаңыздың оқуын қадағалаңыз",
    childrenLabel: "Менің студенттерім", addChild: "Студент қосу",
    progressLabel: "Прогресс", attendanceLabel: "Қатысым", gradesLabel: "Бағалар",
    messagesLabel: "Хабарлар", reportLabel: "Есеп алу", noChildren: "Тіркелген студент табылмады",
  },
  learningPlans: {
    title: "Оқу жоспарлары", subtitle: "Жекелендірілген оқу жолдарыңыз",
    createPlan: "Жоспар құру", myPlans: "Менің жоспарларым", recommended: "Ұсынылған",
    duration: "Ұзақтығы", modules: "Модульдер", startPlan: "Жоспарды бастау",
    progress: "Прогресс", completed: "Аяқталды", noPlans: "Жоспар табылмады",
  },
  instructor: {
    title: "Оқытушы хабы", subtitle: "Сабақ беру тәжірибеңізді басқарыңыз",
    analytics: "Аналитика", courseBuilder: "Курс құрастырушы", earnings: "Менің кірісім",
    insights: "Студент мәліметі", aiStudio: "AI студия", aiQueue: "AI кезек",
    volunteer: "Волонтер бағдарламасы",
    studentsLabel: "Студенттер", coursesLabel: "Курстар",
    revenueLabel: "Кіріс", ratingLabel: "Баға",
  },
  admin: {
    title: "Әкімші тақтасы", subtitle: "Платформаны басқару және мониторинг",
    users: "Пайдаланушылар", content: "Контент", security: "Қауіпсіздік", payments: "Төлемдер",
    reports: "Есептер", settings: "Параметрлер", monitoring: "Мониторинг",
    email: "Электронды пошта", sso: "SSO", lti: "LTI", connectors: "Коннекторлар",
    departments: "Бөлімдер", automation: "Автоматтандыру", aiAgents: "AI агенттер",
    approvals: "Мақұлдаулар", volunteer: "Волонтер", alarms: "Дабылдар",
    observability: "Бақыланушылық", proctoring: "Прокторинг", tools: "Құралдар",
    totalUsers: "Барлығы пайдаланушы", activeToday: "Бүгін белсенді",
    revenue: "Кіріс", uptime: "Жұмыс уақыты",
  },
  errors: {
    notFoundTitle: "Бет табылмады",
    notFoundDesc: "Сіз іздеген бет көшірілген, жойылған немесе мүлдем болмауы мүмкін.",
    notFoundHome: "Басты бет", notFoundCatalog: "Курстарды шолу",
    serverError: "Сервер қатесі орын алды. Қайта байқаңыз.",
    unauthorized: "Бұл бетті қарауға рұқсатыңыз жоқ.",
    forbidden: "Қол жеткізу болдырылмайды.",
    networkError: "Қосылым қатесі. Интернет қосылымын тексеріңіз.",
  },
  roadmap: {
    title: "Менің оқу жол картам", subtitle: "Мансаптық жолыңызды жоспарлаңыз",
    milestones: "Кезеңдер", upcoming: "Алдағы", completed: "Аяқталды",
    inProgress: "Орындалуда", noMilestones: "Кезеңдер табылмады",
  },
  peerReview: {
    title: "Құрдас бағалауы", subtitle: "Бірге оқыңыз, бірге бағалаңыз",
    submitWork: "Жұмысты тапсыру", reviewPeers: "Құрдастарды бағалау", myReviews: "Менің бағалауларым",
    criteria: "Критерийлер", score: "Балл", feedback: "Кері байланыс",
    feedbackPh: "Бағалауыңызды жазыңыз...", submitReview: "Бағалауды жіберу",
    noReviews: "Бағалау табылмады",
  },
  languageLab: {
    title: "Тіл лабораториясы", subtitle: "Шет тіліңізді тәжірибеден өткізіңіз",
    practiceBtn: "Тәжірибе", vocabulary: "Сөздік қор", grammar: "Грамматика",
    listening: "Тыңдау", speaking: "Сөйлеу", writing: "Жазу",
    levelBeginner: "Бастаушы", levelIntermediate: "Орташа", levelAdvanced: "Жоғары",
    streak: "Серия", xpEarned: "Жиналған XP",
  },
  mathLab: {
    title: "Математика лабораториясы", subtitle: "Есептеу және графика құралдары",
    calculate: "Есептеу", graph: "График", matrix: "Матрица", statistics: "Статистика",
    expression: "Өрнек", expressionPh: "Математикалық өрнекті енгізіңіз...",
    solveBtn: "Шешу", result: "Нәтиже", history: "Тарих", noHistory: "Тарих жоқ",
  },
  adaptiveQuiz: {
    title: "Бейімделгіш тест", subtitle: "Сіздің деңгейіңізге бейімделген сұрақтар",
    startBtn: "Емтиханды бастау", continueBtn: "Жалғастыру", nextBtn: "Келесі",
    questionLabel: "Сұрақ", difficulty: "Қиындық", submitAnswer: "Жауапты жіберу",
    correctAnswer: "Дұрыс!", wrongAnswer: "Қате", explanation: "Түсіндірме",
    quizComplete: "Тест аяқталды!", yourScore: "Сіздің балыңыз", retryBtn: "Қайта байқау",
    selectCourse: "Курсты таңдау", selectDifficulty: "Қиындықты таңдау", questionsCount: "Сұрақ саны",
  },
  analytics: {
    title: "Аналитика орталығы", subtitle: "Платформаны нақты уақытта мониторингтеу",
    liveData: "Тікелей дерек", lastUpdated: "Соңғы жаңарту", previousPeriod: "өткен кезеңмен",
    totalEnrollments: "Барлығы тіркелу", completionRate: "Аяқтау пайызы", totalRevenue: "Жалпы кіріс",
    activeUsers: "Белсенді пайдаланушылар", npsScore: "NPS индексі", avgSession: "Орт. сессия уақыты",
    enrollmentTrend: "Тіркелу және аяқтау тренді", completionTrend: "Уақыт ішіндегі студент белсенділігі",
    dailyRevenue: "Күнделікті кіріс", dailyRevenueDesc: "Кезең бойы кіріс үлестірімі",
    userActivity: "Белсенді пайдаланушылар", userActivityDesc: "Күнделікті бірегей сессиялар",
    topCourses: "Үздік курстар", categoryDist: "Санат бойынша үлестіру",
    retention: "Когорттық ұстау талдауы", retentionDesc: "Апталық студент ұстау пайызы",
    cohortLabel: "Когорт", weekLabel: "Апт.",
    courseTitle: "Курс атауы", enrollments: "Тіркелулер", completions: "Аяқтаулар", revenue: "Кіріс",
    demoData: "Демо дерек көрсетіліп тұр", minutesSuffix: "мин",
    day7: "7 күн", day30: "30 күн", day90: "90 күн",
  },
};
...
// Export
// ─────────────────────────────────────────────────────────────────────────────
export const strings: Record<LangKey, I18nStrings> = { tr, en, de, ar, ru, kk };
