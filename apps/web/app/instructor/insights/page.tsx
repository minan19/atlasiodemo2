                ...
                >
                  ...
                  <td className="px-3 py-2.5 text-right">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      <span className="text-xs font-semibold text-amber-700">{s.completion}%</span>
                    </div>
                  </td>
                ...
                : reviewQueue.map((q) => (
                    <div key={q.id} className="rounded-xl border border-slate-200 bg-white/80 p-3 hover:border-amber-200 transition-colors">
                      ...
                      <div className="flex gap-2 mt-2 text-xs">
                        <button className="btn-link" style={{ background: "rgba(200,169,106,0.1)", borderColor: "rgba(200,169,106,0.4)", color: "#C8A96A" }}>{t.tr("✓ Onayla")}</button>
